    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="rounded-[32px] border border-slate-800 bg-slate-950/90 p-6 shadow-2xl shadow-slate-950/20">
          ...
          <button
            ...
            className="mt-6 w-full rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <div className="rounded-[32px] border border-slate-800 bg-slate-950/90 p-6 shadow-2xl shadow-slate-950/20">
          ...
          <div className="mt-6 space-y-3 max-h-[520px] overflow-auto">
            {candidates.length === 0 ? (
              <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-5 text-slate-400">
                Loading candidates…
              </div>
            ) : (
              candidates.map((candidate) => (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <p className="font-semibold">{candidate.anonymized_name}</p>
      ...
      {comparison && (
        <div className="rounded-[32px] border border-slate-800 bg-slate-950/90 p-6 shadow-2xl shadow-slate-950/20">
          ...
          <div className="mt-6 rounded-3xl border border-slate-800 bg-slate-900/60 p-5 text-slate-300">
